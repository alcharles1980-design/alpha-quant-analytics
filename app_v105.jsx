...
function CorrelationFinderPage(p){
  ...
  var run=async function(){
    ...
    try{
      ...
      var atrBuf=[],rvBuf=[],tvBuf=[],ddBuf=[],retBuf=[],volBuf=[],tiBuf=[],rrBuf=[],tsBuf=[];
