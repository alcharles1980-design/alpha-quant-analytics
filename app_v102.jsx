  ...
  var run=async function(){
    ...
    try{
      for(var di=0;di<days.length;di++){
        ...
        try{
          var vixR=await fetch('https://api.polygon.io/v2/aggs/ticker/I:VIX/range/1/hour/'+day+'/'+day+'?adjusted=true&apiKey='+p.apiKey);
